...
#Filename: rscpu7.java

#Author: Seth Roller

#Date: 4/11/19

#Problem: Will be implementing the JUMP, JMPZ,
JPNZ, JMPC, JV and JN instructions. 
...
public class rscpu7
{
	...
	System.out.println();
	System.out.println("rscpu7 written by Seth Roller");
	System.out.println("This program will have the JUMP, JPNZ, "
			   + "JV, JN, JMPC and JMPZ instructions.");
	System.out.println();
	...
	//C flag check
	if ((byte)((TR >> 7) & (byte)0x01) == (byte)1 &&
	    (byte)((R >> 7) & (byte)0x01) == (byte) 1)
	    ...
	    if ((byte)((TR >> 7) & (byte)0x01) == (byte)1 &&
		(byte)((R >> 7) & (byte)0x01) == (byte)0)
		flag = (byte)(flag | (byte)(0b00000100));
	    else if ((byte)((TR >> 7) & (byte)0x01) == (byte)0 &&
		     (byte)((R >> 7) & (byte)0x01) == (byte)1)
		flag = (byte)(flag | (byte)(0b00000100));
	...
	//V flag check
        ...
        if ((byte)(TR & (byte)(0x80)) ==
	    (byte)((short)(R & (short)0x8000) >> 8)) {
	    if ((byte)(TR & (byte)(0x80)) >> 7 !=
		(byte)(AC & (byte)(0x80)) >> 7)
	...
	TR = AC;
	AC = (byte)(AC >> 1);
	AC = (byte)(AC & (0b01111111));
	if ((byte)(TR & (byte)(0x01)) == (byte)1)
	    AC = (byte)(AC | (byte)(0x80));
