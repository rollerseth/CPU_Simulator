...
#Filename: rscpu3.java

#Author: Seth Roller

#Date: 3/14/19

#Problem: Will be implementing the LDAC, 
STAC, and MOVI instructions. 
...
public class rscpu3
{
	...
	System.out.println();
	System.out.println("rscpu3 written by Seth Roller");
	System.out.println("This program will have the LDAC, "
			   + "STAC, and MOVI instructions implemented.");
	System.out.println();
	...
	System.out.printf("STAC4: AC = %d M[AR] = %d", 
			  (int)(AC & (int)(0xff)), (int)(memory[AR] & (int)(0xff)));
	System.out.println();
