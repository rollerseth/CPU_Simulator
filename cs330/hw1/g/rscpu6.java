...
#Filename: rscpu6.java

#Author: Seth Roller

#Date: 4/4/19

#Problem: Will be implementing the RL, RR,
...
public class rscpu6
{
	...
	System.out.println();
	System.out.println("rscpu6 written by Seth Roller");
	System.out.println("This program will have the RR, RL, "
			   + "LSL and LSR instructions.");
	System.out.println();
	...
	//V flag check
        ...
        if ((byte)(TR & (byte)(0x80)) == (byte)(R & (byte)0x80)) {
