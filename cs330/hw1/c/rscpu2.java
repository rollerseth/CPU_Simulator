...
#Filename: rscpu2.java

#Author: Seth Roller

#Date: 2/28/19

#Problem: Will be implementing the INAC, 
CLAC, MOVR, and MVAC instructions. 
...
public class rscpu2
{
	...
	System.out.println();
	System.out.println("rscpu2 written by Seth Roller");
	System.out.println("This program will have the INAC, CLAC, "
			   + "MOVR, MVAC instructions implemented.");
	System.out.println();
	...
	DR = AC;
	R = DR;
	System.out.println("MVAC instructin");
	System.out.printf("MVAC R = %d", R);
	System.out.println();
	...
	System.out.printf("MOVR AC = %d", AC);
	System.out.println();
	// assign DR back to original 
	DR = TR;
    }
	...
	System.out.printf("INAC AC = %d ZCVN = %d%d%d%d", AC,
			  (byte)((flag & (byte)0x08) >> 3),
			  (byte)((flag & (byte)0x04) >> 2),
			  (byte)((flag & (byte)0x02) >> 1),
			  (byte)(flag & (byte)0x01));
